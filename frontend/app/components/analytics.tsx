...
function AnalyticsContent({data}:{data:Analytics}){const maxTss=Math.max(1,...data.weekly.map(item=>item.tss));return <>
 ...
 <p className="analytics-note">Las curvas se calculan desde streams de Strava. TSS e IF se conservan de TrainingPeaks. Las zonas son estimadas hasta que configures tu FTP y frecuencia cardíaca máxima.</p>
 </>}
